...
function postTabs (args, content) {
  ...
  for (let i = 0; i < matches.length; i += 2) {
    ...
    tabIcon.length > 0 && (tabIcon = `<i ${isOnlyicon} class="tab flecicon ${icon}"></i>`)

    const toTop = '<button type="button" class="tab-to-top" aria-label="scroll to top"><i class="flecicon flec-arrow-up-line"></i></button>'
